...
<div class="max-w-3xl p-6 mx-auto mt-10 bg-white rounded-lg shadow-lg">
    <h2 class="mb-4 text-2xl font-bold text-center text-gray-800">Kuisioner Gaya Belajar</h2>
    <p class="mb-6 text-center text-gray-600">Pilih jawaban yang paling sesuai dengan gaya belajar Anda.</p>

    <form action="{{ route('questionnaire2.store') }}" method="POST">
        @csrf

        @foreach ($questionsLearningStyle as $index => $question)
